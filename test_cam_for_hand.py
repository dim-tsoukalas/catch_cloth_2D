...
go_forward = LED(15, pin_factory=factory)
...
# while True:
#     print(cam.get_lowest_middle_point_at_catch())
# Full forward hand: (370, 364)
...
# x_filename = 'hand_positions_x.txt'
# counter_x = 1
# while os.path.exists(x_filename):
#         x_filename = f'hand_positions_x_{counter_x}.txt'
#         counter_x += 1
...
# # Y positions 
# y_filename = 'hand_positions_y.txt'
# counter_y = 1
# while os.path.exists(y_filename):
#         y_filename = f'hand_positions_y_{counter_y}.txt'
#         counter_y += 1
...
# with open('hand_positions_x.txt', 'rb') as f:
#     x= pickle.load(f)

# with open('hand_positions_y.txt', 'rb') as f:
#     y= pickle.load(f)
